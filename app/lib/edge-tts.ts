...
class EdgeTTS {
	...
	_saveSubFile(subFile: subLine[], text: string, audioPath: string) {
		...
		writeFileSync(subPath, JSON.stringify(subFile, null, '  '), {
			encoding: 'utf-8',
		});
	}
	...
	async ttsResponse(text: string, headers: Headers) {
